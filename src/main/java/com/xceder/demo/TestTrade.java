...
import com.xceder.ctp.trade.CThostFtdcTraderApi;
import com.xceder.ctp.trade.CThostFtdcTraderSpi;
...
public class TestTrade
{
    public static void main( String[] argv )
    {
        ...
        ftdcTraderApi.RegisterFront( Pointer.pointerToCString( "tcp://180.168.146.187:10030" ) );
        // 申万期货
